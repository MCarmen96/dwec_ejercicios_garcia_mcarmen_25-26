...
let buscar=prompt("introduce la palabra a buscar: ")
...
if(contador>0){
  ...
  console.log("la palabra ${buscar} aparece "+contador)
}else{

  console.log("la palabra ${buscar} no aparece ")
}
